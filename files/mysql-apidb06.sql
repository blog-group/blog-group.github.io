...
CREATE DATABASE IF NOT EXISTS luohe
  DEFAULT CHARACTER SET utf8mb4
  DEFAULT COLLATE utf8mb4_unicode_ci;
USE luohe;

--
-- Definition of table `luohe`.`acls`
--

DROP TABLE IF EXISTS `luohe`.`acls`;
CREATE TABLE  `luohe`.`acls` (
  `id` int(11) NOT NULL auto_increment,
  `address` int(10) unsigned NOT NULL,
  `netmask` int(10) unsigned NOT NULL,
  `k` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `luohe`.`acls`
--
...
--
-- Definition of table `luohe`.`changeset_tags`
--

DROP TABLE IF EXISTS `luohe`.`changeset_tags`;
CREATE TABLE  `luohe`.`changeset_tags` (
  `changeset_id` bigint(64) NOT NULL,
  `k` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `v` varchar(255) NOT NULL default '',
  KEY `changeset_tags_id_idx` (`changeset_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `luohe`.`changeset_tags`
--
...
--
-- Definition of table `luohe`.`changesets`
--

DROP TABLE IF EXISTS `luohe`.`changesets`;
CREATE TABLE  `luohe`.`changesets` (
...
--
-- Dumping data for table `luohe`.`changesets`
--
...
--
-- Definition of table `luohe`.`current_node_tags`
--

DROP TABLE IF EXISTS `luohe`.`current_node_tags`;
CREATE TABLE  `luohe`.`current_node_tags` (
...
--
-- Dumping data for table `luohe`.`current_node_tags`
--
...
--
-- Definition of table `luohe`.`current_nodes`
--

DROP TABLE IF EXISTS `luohe`.`current_nodes`;
CREATE TABLE  `luohe`.`current_nodes` (
...
--
-- Dumping data for table `luohe`.`current_nodes`
--
...
--
-- Definition of table `luohe`.`current_relation_members`
--

DROP TABLE IF EXISTS `luohe`.`current_relation_members`;
CREATE TABLE  `luohe`.`current_relation_members` (
...
--
-- Dumping data for table `luohe`.`current_relation_members`
--
...
--
-- Definition of table `luohe`.`current_relation_tags`
--

DROP TABLE IF EXISTS `luohe`.`current_relation_tags`;
CREATE TABLE  `luohe`.`current_relation_tags` (
...
--
-- Dumping data for table `luohe`.`current_relation_tags`
--
...
--
-- Definition of table `luohe`.`current_relations`
--

DROP TABLE IF EXISTS `luohe`.`current_relations`;
CREATE TABLE  `luohe`.`current_relations` (
...
--
-- Dumping data for table `luohe`.`current_relations`
--
...
--
-- Definition of table `luohe`.`current_way_nodes`
--

DROP TABLE IF EXISTS `luohe`.`current_way_nodes`;
CREATE TABLE  `luohe`.`current_way_nodes` (
  `id` bigint(64) NOT NULL,
  `node_id` bigint(64) NOT NULL,
...
--
-- Dumping data for table `luohe`.`current_way_nodes`
--
...
--
-- Definition of table `luohe`.`current_way_tags`
--

DROP TABLE IF EXISTS `luohe`.`current_way_tags`;
CREATE TABLE  `luohe`.`current_way_tags` (
...
--
-- Dumping data for table `luohe`.`current_way_tags`
--
...
--
-- Definition of table `luohe`.`current_ways`
--

DROP TABLE IF EXISTS `luohe`.`current_ways`;
CREATE TABLE  `luohe`.`current_ways` (
  `id` bigint(64) NOT NULL auto_increment,
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `visible` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `luohe`.`current_ways`
--
...
--
-- Definition of table `luohe`.`diary_comments`
--

DROP TABLE IF EXISTS `luohe`.`diary_comments`;
CREATE TABLE  `luohe`.`diary_comments` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `luohe`.`diary_comments`
--
...
--
-- Definition of table `luohe`.`diary_entries`
--

DROP TABLE IF EXISTS `luohe`.`diary_entries`;
CREATE TABLE  `luohe`.`diary_entries` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `luohe`.`diary_entries`
--
...
--
-- Definition of table `luohe`.`friends`
--

DROP TABLE IF EXISTS `luohe`.`friends`;
CREATE TABLE  `luohe`.`friends` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `luohe`.`friends`
--
...
--
-- Definition of table `luohe`.`gps_points`
--

DROP TABLE IF EXISTS `luohe`.`gps_points`;
CREATE TABLE  `luohe`.`gps_points` (
...
--
-- Dumping data for table `luohe`.`gps_points`
--
...
--
-- Definition of table `luohe`.`gpx_file_tags`
--

DROP TABLE IF EXISTS `luohe`.`gpx_file_tags`;
CREATE TABLE  `luohe`.`gpx_file_tags` (
...
--
-- Dumping data for table `luohe`.`gpx_file_tags`
--
...
--
-- Definition of table `luohe`.`gpx_files`
--

DROP TABLE IF EXISTS `luohe`.`gpx_files`;
CREATE TABLE  `luohe`.`gpx_files` (
  `id` bigint(64) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `luohe`.`gpx_files`
--
...
--
-- Definition of table `luohe`.`messages`
--

DROP TABLE IF EXISTS `luohe`.`messages`;
CREATE TABLE  `luohe`.`messages` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `luohe`.`messages`
--
...
--
-- Definition of table `luohe`.`node_tags`
--

DROP TABLE IF EXISTS `luohe`.`node_tags`;
CREATE TABLE  `luohe`.`node_tags` (
  `node_id` bigint(64) NOT NULL,
  `version` bigint(20) NOT NULL,
  `k` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `v` varchar(255) NOT NULL default '',
...
--
-- Dumping data for table `luohe`.`node_tags`
--
...
--
-- Definition of table `luohe`.`nodes`
--

DROP TABLE IF EXISTS `luohe`.`nodes`;
CREATE TABLE  `luohe`.`nodes` (
  `node_id` bigint(64) NOT NULL,
  `latitude` int(11) NOT NULL,
  `longitude` int(11) NOT NULL,
  `changeset_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `luohe`.`nodes`
--
...
--
-- Definition of table `luohe`.`relation_members`
--

DROP TABLE IF EXISTS `luohe`.`relation_members`;
CREATE TABLE  `luohe`.`relation_members` (
...
--
-- Dumping data for table `luohe`.`relation_members`
--
...
--
-- Definition of table `luohe`.`relation_tags`
--

DROP TABLE IF EXISTS `luohe`.`relation_tags`;
CREATE TABLE  `luohe`.`relation_tags` (
  `relation_id` bigint(64) NOT NULL default '0',
  `k` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `v` varchar(255) NOT NULL default '',
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `luohe`.`relation_tags`
--
...
--
-- Definition of table `luohe`.`relations`
--

DROP TABLE IF EXISTS `luohe`.`relations`;
CREATE TABLE  `luohe`.`relations` (
  `relation_id` bigint(64) NOT NULL default '0',
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `luohe`.`relations`
--
...
--
-- Definition of table `luohe`.`schema_migrations`
--

DROP TABLE IF EXISTS `luohe`.`schema_migrations`;
CREATE TABLE  `luohe`.`schema_migrations` (
  `version` varchar(255) NOT NULL,
  UNIQUE KEY `unique_schema_migrations` (`version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `luohe`.`schema_migrations`
--

/*!40000 ALTER TABLE `schema_migrations` DISABLE KEYS */;
LOCK TABLES `schema_migrations` WRITE;
INSERT INTO `luohe`.`schema_migrations` VALUES  ('1'),
 ('10'),
 ('11'),
 ('12'),
 ('13'),
...
--
-- Definition of table `luohe`.`sessions`
--

DROP TABLE IF EXISTS `luohe`.`sessions`;
CREATE TABLE  `luohe`.`sessions` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `luohe`.`sessions`
--
...
--
-- Definition of table `luohe`.`user_preferences`
--

DROP TABLE IF EXISTS `luohe`.`user_preferences`;
CREATE TABLE  `luohe`.`user_preferences` (
  `user_id` bigint(20) NOT NULL,
  `k` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `luohe`.`user_preferences`
--
...
--
-- Definition of table `luohe`.`user_tokens`
--

DROP TABLE IF EXISTS `luohe`.`user_tokens`;
CREATE TABLE  `luohe`.`user_tokens` (
  `id` bigint(20) NOT NULL auto_increment,
  `user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `luohe`.`user_tokens`
--
...
--
-- Definition of table `luohe`.`users`
--

DROP TABLE IF EXISTS `luohe`.`users`;
CREATE TABLE  `luohe`.`users` (
...
--
-- Dumping data for table `luohe`.`users`
--
...
--
-- Definition of table `luohe`.`way_nodes`
--

DROP TABLE IF EXISTS `luohe`.`way_nodes`;
CREATE TABLE  `luohe`.`way_nodes` (
  `way_id` bigint(64) NOT NULL,
  `node_id` bigint(64) NOT NULL,
  `version` bigint(20) NOT NULL,
  `sequence_id` bigint(11) NOT NULL,
...
--
-- Dumping data for table `luohe`.`way_nodes`
--
...
--
-- Definition of table `luohe`.`way_tags`
--

DROP TABLE IF EXISTS `luohe`.`way_tags`;
CREATE TABLE  `luohe`.`way_tags` (
...
--
-- Dumping data for table `luohe`.`way_tags`
--
...
--
-- Definition of table `luohe`.`ways`
--

DROP TABLE IF EXISTS `luohe`.`ways`;
CREATE TABLE  `luohe`.`ways` (
  `way_id` bigint(64) NOT NULL default '0',
  `changeset_id` bigint(20) NOT NULL,
  `timestamp` datetime NOT NULL,
  `version` bigint(20) NOT NULL,
...
--
-- Dumping data for table `luohe`.`ways`
--
